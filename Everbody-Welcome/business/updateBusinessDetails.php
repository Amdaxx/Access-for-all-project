    ...
    <div id="formz">
      <form id = "centerform" method="post" >
        <div class="form-group row">
          <label for="cName" class="col-sm-5 col-form-label">Company Name </label>
          <div class="col-sm-10">
        ...
        <div class="form-group row">
          <label for="addr" class="col-sm-5 col-form-label">Address</label>
          <div class="col-sm-10">
            <input type="text" name="address" class="form-control" id="addr" value="<?php echo $res[2];?>"> <br>
          </div>
        </div>
        <div class="form-group row">
          <label for="pstcde" class="col-sm-5 col-form-label">Postcode</label>
          <div class="col-sm-10">
            <input type="text" name="post"  class="form-control" id="pstcde" value="<?php echo $res[1];?>"> <br>
          </div>
        </div>
        <div class="form-group row">
        <label for="num" class="col-sm-5 col-form-label">Contact Number</label>
          <div class="col-sm-10">
