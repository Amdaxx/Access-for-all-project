<link rel="stylesheet" href="topNavHome.css" />
    <div id="header">
      <ul>
        ...
        <button2 onclick="window.location.href='http://localhost/Access-for-all-project/Everbody-Welcome/public/landingPage.php';" type= "button" ><img style = "  margin-top: 14px;" src="http://localhost/Access-for-all-project/Everbody-Welcome/pictures/Everybody-Welcome-logo.png" alt="Logo" width="100" height="50"></img></button2>
