...
<html>
  <head>
    ...
    <meta name="description" content="This page displays the contact information for EverybodyWelcome as well as two entry boxes to allow the user to enter their message to send and their email address to send the message from.">
